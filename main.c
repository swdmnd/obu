...
#define LED_MERAH PORTC.3
#define LED_KUNING PORTC.2
#define LED_HIJAU PORTC.1
DDRC.3=1;DDRC.2=1;DDRC.1=1;
LED_MERAH=0;LED_KUNING=1;LED_HIJAU=1;
...
delay_ms(2000);
while(!PN532_read_uid());

LED_MERAH=1;LED_KUNING=1;LED_HIJAU=0;
while (1)
      {
        switch(gtc_state){
            case GTC_STATE_WAIT_ENTRY: 
                LED_MERAH=1;LED_KUNING=1;LED_HIJAU=0;  
                if(rx_counter!=0) ch = getchar(); 
            ...
            case GTC_STATE_WAIT_ACK:
                LED_MERAH=1;LED_KUNING=0;LED_HIJAU=0;
                if(gtc_timeout == 0) {
                  GTC_Gate_ID[0] = 0;
                  GTC_Gate_ID[1] = 0; 
            ...
            case GTC_STATE_WAIT_EXIT:   
                LED_MERAH=0;LED_KUNING=1;LED_HIJAU=0;
                if(gtc_timeout == 0) {
                  GTC_Gate_ID[0] = 0;
                  GTC_Gate_ID[1] = 0; 
                  gtc_state = GTC_STATE_WAIT_ENTRY;
